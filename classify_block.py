def classify_block():
    ...
    # Determine the block category based on the pseudo-critical pressure
    if p_pch < 300:
        block_cat = 'Low Pressure'
    elif p_pch >= 300 and p_pch < 1500:
        block_cat = 'Medium Pressure'
    else:
        block_cat = 'High Pressure'

    return block_cat

# Call the function to execute the script and return the block category
